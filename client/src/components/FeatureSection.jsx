        ...
        <div className='flex flex-wrap max-sm:justify-center gap-8 mt-8'>
            {shows && shows.length > 0 ? (
                ...
                <div className='w-full text-center py-10'>
                    ...
                    <p className='text-gray-500 text-sm mt-2'>This could be because you need admin access or the server is not responding.</p>
                </div>
            )}
        </div>
        <div className='flex justify-center mt-20'>
            <button onClick={()=>{navigate('/movies'); scrollTo(0,0)}} className='px-10 py-3 text-sm bg-primary-dull transition rounded-md font-medium cursor-pointr'>
                Show more                
            </button>
        </div>
    </div>
